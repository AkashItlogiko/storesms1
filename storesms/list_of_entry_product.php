...
echo "<table class='table table-success table-striped  table-hover'><tr><th>Product Name</th><th>Quentity</th><th>Entry Date</th><th>Action</th></tr>";
...
while($data = mysqli_fetch_assoc($query)){
  ...
  <a href='edit_store_product.php?id=$store_product_id' class='btn btn-danger'>Delete</a>
  </td>
  </tr>";
}
echo "</table>";
